# The Data Science Institute Data Management Portal

## Usage

The project is meant to be used as part of a Docker/Kubernetes container deployment.
...
See the [list of open issues](https://github.com/dsi-icl/dmp/issues) to get an idea of what you could work on.
Or, if you have an awesome idea, please [create a new issue](https://github.com/dsi-icl/dmp/issues/new).
